...
public class SparkFilesTest
{
    ...
    private static void init()
    {
        ...
        jsc.addJar("/home/titanic/soft/intellij_work/hadoop/com-alluxio/target/com-alluxio-1.0-SNAPSHOT.jar");

        JavaRDD<String> rdd = jsc.textFile("alluxio://localhost:19998/alluxio/README.md");
