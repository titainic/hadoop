...
//        test();
    ...
    public static void view() throws IOException, PythonExecutionException
    {
        double x = 1.11d;
        double y = 2d * x + 5d;
        ...
        double y2 = 7d * x - 4d;
        Plot plt = Plot.create(PythonConfig.pyenvConfig("anaconda3-4.6.11"));
        plt.plot().add(Arrays.asList(x, y)).add(Arrays.asList(x2, y2));
        plt.show();
    }
    ...
    public static void test() throws IOException, PythonExecutionException
    {
        Plot plt = Plot.create(PythonConfig.pyenvConfig("anaconda3-4.6.11"));
        plt.plot()
                .add(Arrays.asList(1.3, 2, 20, 30, 40, 100), Arrays.asList(1, 4, 10, 20, 10, 80))
                .label("label");
//                .linestyle("-");
...
//        plt.subplot(2, 1, 2);
    ...
    public static void testThirdArgError() throws IOException, PythonExecutionException
    {
        ...
        Plot plt = Plot.create(PythonConfig.pyenvConfig("anaconda3-4.6.11"));
        plt.plot().add(Arrays.asList(1.3, 2));
        plt.plot().add(Arrays.asList(5, 7,2,9,20),Arrays.asList(1,2,1,2,1));
