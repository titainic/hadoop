...
public class LinearRegressionNNSpark
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("LinearRegressionNNSpark").setMaster("spark://titanic:7077");
...
//        sparkConf.set()
        ...
        VoidConfiguration conf = VoidConfiguration.builder()
                ...
                .networkMask("10.168.0.0/24")     //Network mask for communication. Examples 10.0.0.0/24, or 192.168.0.0/16 etc
